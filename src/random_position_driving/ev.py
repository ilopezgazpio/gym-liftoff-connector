...
checkpoints = sorted(
    [
        p for p in valid_checkpoints
        if int(p.stem.split("_")[-1]) % 10000 == 0
    ],
...
for ckpt_path in checkpoints:
    ...
    results.append({
        ...
        "success_rate": num_truncated / 1000
    })
...
df.to_csv("success_evaluation.csv", index=False)

print("Saved: success_evaluation.csv")
